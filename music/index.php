...
<body>
<div class="container">
    <h1><a href="https://music.163.com/song?id=<?php echo $name['id'];?>"><?php echo $name['name'];?> - <?php echo $name['singer'];?></a></h1>
...
<script>var aud = document.getElementById("aud");aud.onended = function(){location.reload();};</script>
</body>
</html>
