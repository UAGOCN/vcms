...
class AdminAction extends BaseAction{
    ...
    public function configsave(){
		...
		//
		$pp_play = 'var san_root="'.$config['site_path'].'";';
		$pp_play.= 'var san_width='.$config['play_width'].';';
		$pp_play.= 'var san_height='.$config['play_height'].';';
		$pp_play.= 'var san_showlist='.$config['play_show'].';';
		$pp_play.= 'var san_second='.intval($config['play_second']).';';
		foreach(C('play_server') as $key=>$value){
			$pp_play.= 'var san_'.$key.'="'.$value.'";';
		}
