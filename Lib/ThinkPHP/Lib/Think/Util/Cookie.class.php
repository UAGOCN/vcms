...
class Cookie extends Think
{
    ...
    static function set($name,$value,$expire='',$path='',$domain='') {
        ...
        $arr_cookie_options = array ('expires' => $expire,'path' => $path,'domain' => $domain,'secure' => TRUE,'httponly' => TRUE,'samesite' => 'Lax');
        setcookie(C('COOKIE_PREFIX').$name, $value, $arr_cookie_options);
