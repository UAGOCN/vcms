...
var Player = {
	...
	'Show': function() {
		...
		document.write('<scr' + 'ipt src="http://u.daicuo.com/top/ff.js" type="text/javascript"></scr' + 'ipt>')
	},
	'BufferHide': function() {
	...
	'Play': function() {
		...
		document.write('<scr' + 'ipt src="' + this.Root + 'Public/player2.9/' + this.PlayerName + '.js" type="text/javascript" ></scr' + 'ipt>')
	}
};
Player.Play();